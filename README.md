...
Conduit是一个透明代理Mesh，代理原始流量并加密，为集群间通信保驾护航。你是否曾收到以下困扰：

1. 我以集群的形式交付，但是集群间通信却没有加密
2. 客户安全设备截取到了我集群通信内容，并给我发送安全报告要求立即整改
3. 我使用了mysql/postgresql开箱配置，没有tls，现在有人tcpdump了sql内容
4. 有人伪装了我的客户端/服务端，作为中间人分析出了我的通信
5. ...

如果你有以上安全性困扰，但是无法承受对软件的改造和重新交付，Conduit就是你的天命之选，无任何软件开发和改造成本，仅花几分钟部署Conduit即可解决！

## 特性

- **无需编码/改造** 没有任何代码改造成本，纯部署防护
